...
export default function CartProduct({ cartProduct, removeProductFromCart, updateCartProductCount }) {
    const [count, setCount] = useState(cartProduct.count);
    return (
        <div className="cart-product shadow rounded-2 my-3">
            <div className="row align-items-center">
                <div className="col-md-2">
                    <img src={cartProduct.product.imageCover} className="w-100" alt="Product" />
                </div>
                <div className="col-md-8">
                    ...
                    <p className="fw-bolder">
                        Total Price: <span>{cartProduct.price * cartProduct.count} EGP</span>
                    </p>
                </div>
                <div className="col-md-2">
                    <button
                        onClick={() => {
                            removeProductFromCart(cartProduct.product._id);
                        }}
